...
?>
    <!-- Área cliente CSS -->
    <link rel="stylesheet" type="text/css" href="../pages/area_favorito/area_favorito.css?v=<?php echo uniqid(); ?>">
    <!-- Menu cliente CSS -->
    ...
    <body>
        ...
        >
            <?php 
                ...
                require_once "pages/area_favorito/content/area_favorito_content.php"; 
        ...
        <!-- Cliente JS -->
        <script src="../pages/area_favorito/area_favorito.js?v=<?php echo uniqid(); ?>"></script>
        <!-- Menu cliente JS -->
